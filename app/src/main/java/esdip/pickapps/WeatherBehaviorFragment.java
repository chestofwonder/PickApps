...
public class WeatherBehaviorFragment extends Fragment {
    ...
    public WeatherBehaviorFragment() {
        // Required empty public constructor
    }

    public static WeatherBehaviorFragment newInstance() {
        WeatherBehaviorFragment fragment = new WeatherBehaviorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_weather_behavior, container, false);
        createView(view);
    ...
    private void createView(View view){
        Log.i(DEBUG_TAG, "createView");

        ArrayList<String> weather_constants = WeatherIntentService.getWeatherConstants();
        ...
        Iterator<String> iterator = weather_constants.iterator();
        ...
        while (iterator.hasNext()){
            ...
            int resourceId = resources.getIdentifier("thumb_icon_" + constant, "drawable", getContext().getPackageName());

            ImageView new_icon = new ImageView(this.getActivity());
            new_icon.setPadding(10, 10, 10, 10);
            Bitmap new_icon_bitmap = BitmapFactory.decodeResource(getContext().getResources(), resourceId);
            Bitmap new_icon_resized = Bitmap.createScaledBitmap(new_icon_bitmap, icon_size, icon_size, false);
            new_icon.setImageBitmap(new_icon_resized);
            new_icon.setLayoutParams(layout_param);
            new_icon_bitmap.recycle();

            grid.addView(new_icon);
            ...
            //new_image.setId(constant);

            new_image_bitmap.recycle();

            //new_image.setBackgroundColor(Color.DKGRAY);
    ...
    public interface OnFragmentInteractionListener {
        void onWeatherConfigFragmentInteraction(ImageView image_view);
    }
    ...
    private void saveCustomWallpaper(String package_name) {
       ...
       // progress.setTitle(getString(R.string.saving_wallpaper));
        progress.setMessage(getString(R.string.saving_wallpaper));
        progress.show();
         ...
         //   @Override
           // public void run() {
                try{
                    ...
                    contentValues.put("wallpaper_behavior", MainService.BEHAVIOR_WEATHER);
